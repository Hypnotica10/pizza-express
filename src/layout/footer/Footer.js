    ...
    return (
        <footer className='text-white bg-footer py-12'>
            <div className='container'>
                ...
                <h4 className='company-tile text-center font-semibold text-yellow mb-2 uppercase text-base'>CÔNG TY TNHH PIZZA EXPRESS VIỆT NAM</h4>
                <div className='pb-4'>
                    <p className='text-center mb-1.5'>
                        <span className=''>Để đặt bánh pizza, vui lòng liên hệ tổng đài số: </span>
                        <a href='tel:02436888777' className=''>(024) 36.888.777</a>
                    </p>
                    <p className='text-center mb-1.5'>
                        <span className=''>Để phản ánh chất lượng dịch vụ, vui lòng gọi số: </span>
                        <a href='tel:0977128833' className=''>0977.128.833</a>
                    </p>
                    <p className='text-center mb-1.5'>
                        <span className=''>Email: </span>
                        <a href='mailto:lienhepizzaexpress@gmail.com' className=''>lienhepizzaexpress@gmail.com</a>
                    </p>
                    <p className='text-center mb-1.5'>
                ...
                <div className=''>
                    ...
                    <p className='text-center even:leading-7 text-xs'>
                        ...
                        <br />
                        <span>Địa Chỉ: Số 352 Đường Bưởi, P.Vĩnh Phúc, Q.Ba Đình, TP.Hà Nội</span>
                        <br />
                        <span>Số điện thoại: 02436888777</span>
                        <br />
                        <a href='mailto:lienhepizzaexpress@gmail.com'>Email: lienhepizzaexpress@gmail.com</a>
                    </p>
                </div>
            </div>
        </footer>
